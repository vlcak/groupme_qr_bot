...
func NewHandler(imageService *ImageService, messageService *MessageService, botID, dbURL string) *Handler {
	h := &Handler{}
	h.messageProcessor = NewMessageProcessor(imageService, messageService, botID, dbURL)
